...
################################################################################
alt_repetition_stage_4 <- function() {
    ####################
    # Input validation #
    ####################
    ...
    while ((cost_so_far <= max_total_cost) &
        ...
        ###########################
        pay_per_label <- alt_decide_price_per_label(training_set,
                                                payment_selection_criteria,
        ...
        k_batch_size = floor(k_budget_size/pay_per_label)
