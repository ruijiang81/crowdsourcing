...
DATABASE_NAME="OTTODomino250Robust" #IMPORTANT TO SET THIS NAME!!!
#DATABASE_NAME="SPAM" #IMPORTANT TO SET THIS NAME!!!
#DATABASE_NAME="OTTO" #IMPORTANT TO SET THIS NAME!!!
basic_directory<-"C:\\Users\\user\\Dropbox\\economic labelling pers\\TEST_MODELING"
...
max_total_cost<-250 #should be larger than the cost of paying for the initial training batches
...
directory<<-paste(basic_directory,DATABASE_NAME,payment_selection_criteria, sep = "/", collapse = NULL)
dir.create(directory, showWarnings = TRUE, recursive = TRUE, mode = "0777")
...
dataset <- read.csv("C:\\Users\\user\\Dropbox\\economic labelling pers\\Otto\\Ottotrain.csv", colClasses=c("integer",rep("numeric",93),"factor"))
